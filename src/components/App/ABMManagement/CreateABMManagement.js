...
const CreateABMManagement = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch(API_URL + "ABMprofileCreate", requestOptions)
    ...
    return (
        <Card className="shadow-sm my-5 mx-auto" style={{ maxWidth: "600px", padding: "30px" }}>
            <h3 className="text-center mb-4">Create ABM Management Profile</h3>
...
export default CreateABMManagement;
