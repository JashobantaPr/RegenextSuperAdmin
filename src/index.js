...
import UpdateTarget from "./components/App/TargetManagement/UpdateTarget.js";
...
const UpdateStockist = React.lazy(() =>
  import("./components/App/Stockist/UpdateStockist.js")
);
...
const Target = React.lazy(() => import("./components/App/TargetManagement/Target.js"));
        ...
        <Routes>
          ...
          <Route path={`/`} element={<App />}>
            ...
            <Route>
              ...
              />
              <Route
                path={`${process.env.PUBLIC_URL}/app/UpdateStockist`}
                element={<UpdateStockist />}
              />
              <Route
